    ...
    const templateData = [
      {
        ...
        'Manufacturing Details': 'Made from 100% cotton',
        'Shipping Returns': 'Free shipping, 30-day returns',
        'Size Name': 'S',
        'Quantity': '10',
        'HSN Code': '61091000',
        'SKU': 'TSH001-S',
        ...
        'Meta Title': 'Premium Cotton T-Shirt - Size S',
        'Meta Description': 'Buy premium cotton t-shirt size S online',
      ...
      },
      {
        ...
        'Meta Title': 'Premium Cotton T-Shirt - Size M',
        'Meta Description': 'Buy premium cotton t-shirt size M online',
      ...
      for (let i = 0; i < parsedData.length; i++) {
        ...
        const productData = {
          ...
          sizes: product.sizes.map(size => ({
            ...
            fitWaistCm: size.waistCm,
            inseamLengthCm: size.inseamCm,
            chestCm: size.chestCm,
            frontLengthCm: size.frontLengthCm,
            acrossShoulderCm: size.acrossShoulderCm,
            fitWaistIn: size.waistIn,
            inseamLengthIn: size.inseamIn,
        ...
        try {
          const response = await itemAPI.createItem(productData);
          results.push({
